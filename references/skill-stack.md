...
| Gauntlet loop, independent judge or live progress dashboard | `/sk:work-gauntlet-loop` | `/sk:work-handoff-prepare-and-pickup` when a session runs low | Read `references/workflow-loops.md`. |
